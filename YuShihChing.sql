...
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_STOCK,PRD_PRICE,PRD_STATE) VALUES('PD'||(LPAD(to_char(PD_SEQ.NEXTVAL),8,'0')),'SL000001','PC000002','STRANDMON 扶手椅, Gillhov 彩色',38,7990,'On');
