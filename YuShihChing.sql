...
INSERT INTO REALESTATE VALUES ('ESTATE'||(LPAD(to_char(RE_SEQ.NEXTVAL),4,'0')),'信義房屋');
INSERT INTO REALESTATE VALUES ('ESTATE'||(LPAD(to_char(RE_SEQ.NEXTVAL),4,'0')),'永慶房屋');
INSERT INTO REALESTATE VALUES ('ESTATE'||(LPAD(to_char(RE_SEQ.NEXTVAL),4,'0')),'東森房屋');
...
INSERT INTO REALTOR(RTR_NO, RTR_ID, RTR_PSW, RTRNAME, RTRAREA, ID_NO, RE_NO, RTRSTATE)
...
INSERT INTO REALTOR(RTR_NO, RTR_ID, RTR_PSW, RTRNAME, RTRAREA, ID_NO, RE_NO, RTRSTATE)
VALUES('RT'||(LPAD(to_char(RTR_SEQ.NEXTVAL),8,'0')), 'BA104_RLTR03@GMAIL.COM', '123456', '林志玲', '士林區', 'X298765432', 'ESTATE0002', 'ON');
INSERT INTO REALTOR(RTR_NO, RTR_ID, RTR_PSW, RTRNAME, RTRAREA, ID_NO, RE_NO, RTRSTATE)
VALUES('RT'||(LPAD(to_char(RTR_SEQ.NEXTVAL),8,'0')), 'BA104_RLTR04@GMAIL.COM', '123456', '張三豐', '內湖區', 'D165432178', 'ESTATE0001', 'ON');
INSERT INTO REALTOR(RTR_NO, RTR_ID, RTR_PSW, RTRNAME, RTRAREA, ID_NO, RE_NO, RTRSTATE)
VALUES('RT'||(LPAD(to_char(RTR_SEQ.NEXTVAL),8,'0')), 'BA104_RLTR05@GMAIL.COM', '123456', '林大偉', '大安區', 'C132165491', 'ESTATE0002', 'ON');
INSERT INTO REALTOR(RTR_NO, RTR_ID, RTR_PSW, RTRNAME, RTRAREA, ID_NO, RE_NO, RTRSTATE)
VALUES('RT'||(LPAD(to_char(RTR_SEQ.NEXTVAL),8,'0')), 'BA104_RLTR06@GMAIL.COM', '123456', '李進財', '信義區', 'A198765432', 'ESTATE0001', 'ON');
INSERT INTO REALTOR(RTR_NO, RTR_ID, RTR_PSW, RTRNAME, RTRAREA, ID_NO, RE_NO, RTRSTATE)
VALUES('RT'||(LPAD(to_char(RTR_SEQ.NEXTVAL),8,'0')), 'BA104_RLTR07@GMAIL.COM', '123456', '趙德助', '萬華區', 'H147258369', 'ESTATE0002', 'ON');
INSERT INTO REALTOR(RTR_NO, RTR_ID, RTR_PSW, RTRNAME, RTRAREA, ID_NO, RE_NO, RTRSTATE)
VALUES('RT'||(LPAD(to_char(RTR_SEQ.NEXTVAL),8,'0')), 'BA104_RLTR08@GMAIL.COM', '123456', '張鈞甯', '中山區', 'X265432155', 'ESTATE0001', 'ON');
INSERT INTO REALTOR(RTR_NO, RTR_ID, RTR_PSW, RTRNAME, RTRAREA, ID_NO, RE_NO, RTRSTATE)
VALUES('RT'||(LPAD(to_char(RTR_SEQ.NEXTVAL),8,'0')), 'BA104_RLTR09@GMAIL.COM', '123456', '王小明', '大同區', 'A123466593', 'ESTATE0002', 'ON');
INSERT INTO REALTOR(RTR_NO, RTR_ID, RTR_PSW, RTRNAME, RTRAREA, ID_NO, RE_NO, RTRSTATE)
VALUES('RT'||(LPAD(to_char(RTR_SEQ.NEXTVAL),8,'0')), 'BA104_RLTR10@GMAIL.COM', '123456', '陳金鋒', '大安區', 'F136925874', 'ESTATE0003', 'ON');
INSERT INTO REALTOR(RTR_NO, RTR_ID, RTR_PSW, RTRNAME, RTRAREA, ID_NO, RE_NO, RTRSTATE)
VALUES('RT'||(LPAD(to_char(RTR_SEQ.NEXTVAL),8,'0')), 'BA104_RLTR11@GMAIL.COM', '123456', '連天邊', '信義區', 'H118754326', 'ESTATE0001', 'ON');
INSERT INTO REALTOR(RTR_NO, RTR_ID, RTR_PSW, RTRNAME, RTRAREA, ID_NO, RE_NO, RTRSTATE)
VALUES('RT'||(LPAD(to_char(RTR_SEQ.NEXTVAL),8,'0')), 'BA104_RLTR12@GMAIL.COM', '123456', '楊美麗', '中正區', 'B213456789', 'ESTATE0001', 'ON');
...
INSERT INTO PRD_CATEGORY VALUES ('PDCG'||(LPAD(to_char(PRDT_CATE_SEQ.NEXTVAL),6,'0')),'桌子');
INSERT INTO PRD_CATEGORY VALUES ('PDCG'||(LPAD(to_char(PRDT_CATE_SEQ.NEXTVAL),6,'0')),'椅子');
INSERT INTO PRD_CATEGORY VALUES ('PDCG'||(LPAD(to_char(PRDT_CATE_SEQ.NEXTVAL),6,'0')),'櫃子');
